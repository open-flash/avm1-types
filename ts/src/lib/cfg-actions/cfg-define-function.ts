...
export interface CfgDefineFunction extends ActionBase {
...
export const $CfgDefineFunction: DocumentIoType<CfgDefineFunction> = new DocumentType<CfgDefineFunction>(() => ({
  properties: {
